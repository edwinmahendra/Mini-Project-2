            ...
            <table border=1>
                ...
                <?php 
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>". $row['deskripsiOlahraga']. "</td>";
                        echo "<td>". "<img src='". $row['pathImg']."' class='foto1'>". "</td>";
                        echo "<td>". "<img src='". $row['pathJero']."' class='foto'>". "</td>";
                        echo "<td><a href='edit.php?id=".$row['idOlahraga']."'>Edit</a></td>";
                        echo "<td><a href='deleteWorkout.php?id=".$row['idOlahraga']."'>Delete</a></td>";
                    }
                
                ?>
            </table>
        <div class="tombol">
            <a href="addOlahraga.php" class="add" data-aos="Add Workoutfade-left">Tambahkan Data</a>
        </div>
        <div class="tombol">
